...
{
	// as part of Lab 11 implement this function
	unsigned long i,digitThousands,digitHundreds,digitTens,digitOnes;
	if(n<=9999)
	{
		//n = 0 - 9999
		digitThousands = n/1000 + '0';
		String[0] = digitThousands;
		if(String[0] == '0'){
			String[0] = SP;
		}
		n = n % 1000;								//0-999
		digitHundreds = n/100 + '0';
		String[1] = digitHundreds;
